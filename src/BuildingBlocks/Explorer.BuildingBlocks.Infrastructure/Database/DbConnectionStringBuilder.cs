...
public static class DbConnectionStringBuilder
{
    ...
    {
        var server = Environment.GetEnvironmentVariable("DATABASE_HOST") ?? "5432"; //izmenila
        var port = Environment.GetEnvironmentVariable("DATABASE_PORT") ?? "5432";
        var database = Environment.GetEnvironmentVariable("DATABASE_SCHEMA") ?? "explorer"; //izmenila
